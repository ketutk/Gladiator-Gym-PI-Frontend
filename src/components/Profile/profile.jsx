        ...
        <div class="max-w-xl w-full mx-auto bg-white p-8 border border-gray-300 shadow-md rounded-lg ">
          {user && (
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" class="w-full bg-gray-900 text-white py-2 px-4 rounded-lg hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-600" disabled={!name || isLoading}>
